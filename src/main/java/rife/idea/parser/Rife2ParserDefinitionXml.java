...
import rife.idea.psi.Rife2FileXml;
import rife.template.antlr.TemplateLexer;
import rife.template.antlr.TemplateParser;

public class Rife2ParserDefinitionXml extends Rife2ParserDefinition {
    public static final IFileElementType FILE =
        new IFileElementType(Rife2LanguageXml.INSTANCE);
    ...
    public static void setupLanguageDefinition() {
        PSIElementTypeFactory.defineLanguageIElementTypes(Rife2LanguageXml.INSTANCE,
            TemplateParser.tokenNames,
            TemplateParser.ruleNames);
        var tokenIElementTypes =
            PSIElementTypeFactory.getTokenIElementTypes(Rife2LanguageXml.INSTANCE);
    ...
    public Lexer createLexer(Project project) {
        return new Rife2LexerXml();
    }

    @NotNull
    public PsiParser createParser(final Project project) {
        final var parser = new TemplateParser(null);
        return new ANTLRParserAdaptor(Rife2LanguageXml.INSTANCE, parser) {
            @Override
    ...
    public PsiFile createFile(FileViewProvider viewProvider) {
        return new Rife2FileXml(viewProvider);
    }
}
