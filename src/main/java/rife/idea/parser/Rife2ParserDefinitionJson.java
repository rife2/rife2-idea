...
public class Rife2ParserDefinitionJson extends Rife2ParserDefinition {
    public static final IFileElementType FILE =
        new IFileElementType(Rife2LanguageJson.INSTANCE);
    ...
    public static void setupLanguageDefinition() {
        PSIElementTypeFactory.defineLanguageIElementTypes(Rife2LanguageJson.INSTANCE,
            TemplateParser.tokenNames,
            TemplateParser.ruleNames);
        var tokenIElementTypes =
            PSIElementTypeFactory.getTokenIElementTypes(Rife2LanguageJson.INSTANCE);
    ...
    public Lexer createLexer(Project project) {
        return new Rife2LexerJson();
    }

    @NotNull
    public PsiParser createParser(final Project project) {
        final var parser = new TemplateParser(null);
        return new ANTLRParserAdaptor(Rife2LanguageJson.INSTANCE, parser) {
            @Override
    ...
    public PsiFile createFile(FileViewProvider viewProvider) {
        return new Rife2FileJson(viewProvider);
    }
}
