...
public class Rife2TemplateHighlighterTxt extends LayeredLexerEditorHighlighter {
    public Rife2TemplateHighlighterTxt(@Nullable Project project, @Nullable VirtualFile virtualFile, @NotNull EditorColorsScheme colors) {
        // create the main highlighter
        super(new Rife2SyntaxHighlighterTxt(), colors);
        ...
        if (project == null || virtualFile == null) {
            ...
            if (type == null) {
                type = Rife2LanguageTxt.getDefaultTemplateLang();
            }
        }

        var outerHighlighter = SyntaxHighlighterFactory.getSyntaxHighlighter(type, project, virtualFile);
        registerLayer(Rife2ParserDefinitionTxt.TEXT, new LayerDescriptor(outerHighlighter, ""));
    }
}
