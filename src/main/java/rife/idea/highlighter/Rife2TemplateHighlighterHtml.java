...
public class Rife2TemplateHighlighterHtml extends LayeredLexerEditorHighlighter {
    public Rife2TemplateHighlighterHtml(@Nullable Project project, @Nullable VirtualFile virtualFile, @NotNull EditorColorsScheme colors) {
